    ...
    public static ArrayList<Cancion> leerCanciones() {
        ...
        try ( BufferedReader br = new BufferedReader(new FileReader("top10.csv"))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                Cancion c = new Cancion(datos[1], datos[0], datos[2], Integer.valueOf(datos[3]), Integer.valueOf(datos[4]), Integer.valueOf(datos[5]),  listaHistorial);//esto fue hecho por Steven Miraba
                lista.add(c);
            }
